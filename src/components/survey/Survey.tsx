...
const Survey = ({ survey: { checkboxes }, clearCheckBoxes, handleConfirmationEmail }: SurveyProps) => {
							...
							<form onSubmit={(e) => surveySubmit(e)}>
								...
								<div className={surveyStyle.container}>
									{loading || error || success ? (
										<Alert loading={loading} success={success} error={error} message={message} />
									) : null}
...
export default connect(mapStateToProps, { clearCheckBoxes, handleConfirmationEmail })(Survey);
